  ...
  return (
    ...
    <div className='container mt-16'>
      ...
      <form onSubmit={(event) => { handleSubmit(event) }}>
        <div className="mb-3 ">
          <label htmlFor="exampleInputEmail1" className="form-label mt-3">Enter OTP</label>
          <input
            type="text"
        ...
        <button className='btn-login-signup' type="submit">Verify</button>
        <Link to="/entrypoint/register"> <div className='forget-btn  text-center'>Go back to home sign up page</div> </Link>
      </form>
      <ToastContainer />
    </div>
  )
